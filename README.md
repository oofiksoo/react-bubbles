...
- [x] Explain what a token is used for.
      A tocken stores an encripted "recipt" of sucsessfull authentication
- [x] What steps can you take in your web apps to keep your data secure?
      Use authenticated / private routes for pages that must be secured. This will require authentication prior to rendering the component or page.
- [x] Describe how web servers work.
      web servers host compiled code on a dedicated always available computer. Using IP addressing, or preferably a DNS record in order to retrieve the site by the user.
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      Create - Post - initial creation of an object/record
      Read - Get - transfers exsisting data from the server to the user's browser/client
      Update - Put - re-writes changed elements of a record, or an entire record
      Delete - Delete - deletes a record / data
